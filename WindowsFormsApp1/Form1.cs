...
namespace WindowsFormsApp1
{
    public partial class Form1 : Form
    {
        ...
        private void button2_Click(object sender, EventArgs e)
        {
            ...
            //===============================================================================================================
            PropertyPortalEntities pp = new PropertyPortalEntities();
            int buildingExistsCount;
            var buildingExsists = from b in pp.Buildings where b.Reference.ToString().Trim() == textBox1.Text.Trim() select b;
            ...
            }//End of if (buildingExistsCount < 0)
            else {
                string errortext;
                errortext = "Building " + textBox1.Text + " already Exists !";
                MessageBox.Show(errortext, "Building Exists !", MessageBoxButtons.OK, MessageBoxIcon.Error); //("ERROR !", MessageBoxIcon.Error)
